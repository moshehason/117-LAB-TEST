...
function start(){
 ...
 if(p==="117-pig-runner.html"&&!spoken){spoken=true;setTimeout(whisper,900)}
}
function whisper(){
 if(!("speechSynthesis" in window))return;
 const u=new SpeechSynthesisUtterance("hey... hey... come here");
 u.volume=.055;u.rate=.62;u.pitch=.72;
...
addEventListener("pointerdown",start,{once:true,passive:true});addEventListener("keydown",start,{once:true});
})();